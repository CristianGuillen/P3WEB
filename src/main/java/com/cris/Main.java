...
import com.cris.Servicio.BoostrapServices;
import com.cris.Servicio.DataBaseServices;
import com.cris.Servicio.FilterCookie;
import com.cris.Servicio.UserServices;
import com.cris.clases.Articulo;
import com.cris.clases.Comentario;
import com.cris.clases.Etiqueta;
...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        get("/iniciarSesion", (request, response) -> {
            ...
            attributes.put("titulo", "Iniciar Sesion");
        ...
        get("/gestionarUsuarios", (request, response) -> {
            Map<String, Object> attributes = new HashMap<>();
            Usuario logUser = request.session(true).attribute("usuario");
            attributes.put("titulo", "Nuevo Usuario ");
            attributes.put("logUser", logUser);
        ...
        get("/publicarArticulo", (request, response) -> {
            Map<String, Object> attributes = new HashMap<>();
            Usuario logUser = request.session(true).attribute("usuario");
            attributes.put("titulo", "Nuevo Articulo");
            attributes.put("logUser", logUser);
        ...
        get("/leerArticuloCompleto/:id", (request, response) -> {
            ...
            Map<String, Object> attributes = new HashMap<>();
            Usuario logUser = request.session(true).attribute("usuario");
            attributes.put("titulo", "Articulo");
            attributes.put("logUser", logUser);
        ...
        get("/visualizarUsuario", (request, response) -> {
            ...
            attributes.put("titulo", "Vista de Usuario");
        ...
        get("/editarUsuario", (request, response) -> {
            ...
            Map<String, Object> attributes = new HashMap<>();
            attributes.put("titulo", "Edicion de Usuario");
